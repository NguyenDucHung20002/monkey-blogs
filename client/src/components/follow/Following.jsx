        ...
        return (<>
            <div className="w-72">
                <div className="flex items-center">
                    <div className="w-8 h-8 rounded-1/2 overflow-hidden ">
                ...
                <div key={idx} className=" flex justify-between content-center py-2 ">
                    <div className="flex max-w-[90%]">
                        ...
                        <div className="max-w-[80%] ">
                            <p className="py-1 text-[12px] ml-2 overflow-hidden overflow-ellipsis whitespace-nowrap">{val.fullname}</p>
                        </div>
                    </div>
                    <Popover content={<SmallInf username={val.username} />} trigger={'click'} 

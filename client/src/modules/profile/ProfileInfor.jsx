...
const ProfileInfor = ({setShow, user, isFollow, FetchFollow}) =>
{
    ...
    return (<>
        <div className="mb-8">
            ...
            <div className="flex items-center">
                <button onClick={handleFollowClick} className={`px-4 text-sm py-2 rounded-2xl ${isFollow?`border border-black`: `bg-green-600 text-white`}`}>{isFollow ? "Following": "Follow"}</button>

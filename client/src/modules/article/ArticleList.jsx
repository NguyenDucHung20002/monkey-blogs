...
const ArticleList =({data=[], className=''})=>{
    data=[
        {
            image:"https://miro.medium.com/v2/resize:fit:849/1*GP8az3qyrk7VRYpkEjYFCQ.png",
            avatar:"https://miro.medium.com/v2/resize:fill:25:25/1*sHhtYhaCe2Uc3IU0IgKwIQ.png",
            username:"Medium Staff",
            title:"What We’re Reading: Heritage and history",
            content:"Many writers on Medium embrace this idea of celebrating freedom while sharing stories and histories that interrogate — or explain — heritage",
        },
        {
            image:"https://miro.medium.com/v2/resize:fit:720/0*2cSiSvHvzoexU3r4",
            avatar:"https://miro.medium.com/v2/resize:fill:25:25/1*sHhtYhaCe2Uc3IU0IgKwIQ.png",
            username:"Medium Staff",
            title:"How I Made $500 in Revenue as a Passive Income from My Side Hustle.",
            content:"Want to build a successful side hustle? Read this.",
        },
        {
            image:"https://miro.medium.com/v2/resize:fit:849/1*GP8az3qyrk7VRYpkEjYFCQ.png",
            avatar:"https://miro.medium.com/v2/resize:fill:25:25/1*sHhtYhaCe2Uc3IU0IgKwIQ.png",
                    ...
                    <div className="my-6">
                        <div className="flex py-2">
                            <div className="w-6 h-6 rounded-1/2 overflow-hidden">
                                <img className="w-full h-full " src={val.avatar} alt="" />
                            </div>
                            <div className=" flex  ml-2">
                                <a className="hover:text-black hover:underline" href="#">{val.username}</a>
                                <p className="mx-1" >in</p>
                                <a className="hover:text-black hover:underline" href="#">The Medium Blog</a>
                            </div>
                        </div>
                        <h2 className="text-xl text-black font-bold line-clamp-2">{val.title}</h2>
                        <p className="line-clamp-2 "><a className="hover:text-gray-500" href="#">{val.content}</a></p>
                        ...
                        <div className="flex justify-between ">
                            <div className="flex">
                                <button className="flex">
                                    ...
                                    <span className=" text-xs py-2 px-1 font-[500]">1.5k</span>
                                </button>
                                <button className="flex mx-3">
                                    ...
                                    <span className="text-xs py-2 px-1 font-[500]">15</span>
                                </button>
                            </div>
                            <div className="">
